...
*/
	...
	return array(
		...
		'a_commented_subject' => 'Your ^site_title answer has a new comment from ^f_handle',
		...
		'c_commented_subject' => 'Your ^site_title comment has been added to by ^f_handle',
		...
		'q_commented_subject' => 'Your ^site_title question has a new comment from ^f_handle',
		'q_posted_body' => "A new question has been asked by ^q_handle:\n\n^open^q_title\n\n^q_content^close\n\nClick below to see the question:\n\n^url\n\nThank you,\n\n^site_title",
		'q_posted_subject' => '^site_title has a new question ^open^q_title^close',
